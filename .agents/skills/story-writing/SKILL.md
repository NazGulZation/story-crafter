...
name: story-writing
description: >-
  Unified, authoritative framework for creative writing, narrative fiction, worldbuilding, character design,
  scene drafting, causal consistency auditing, and plot hole repair in this workspace.
  Covers the complete writing lifecycle: planning, drafting, anti-cliché enforcement, 13-point consistency matrix,
  causal repair techniques, dynamic chapter pacing, desktop/web reader formatting, and explicit/NSFW fiction standards.
---
...
```mermaid
flowchart TD
    A[Step 1: Pre-Writing Alignment] --> B[Step 2: Drafting & Word Counts]
    B --> C[Step 3: Post-Draft Causal & Consistency Audit]
    C --> D{Integrity Flaws Found?}
    D -- Yes --> E[Execute Causal Repair Protocol]
    E --> C
    D -- No --> F[Cross-Chapter Continuity Parity Sweep]
    F --> G[Final Chapter Publication]
```
